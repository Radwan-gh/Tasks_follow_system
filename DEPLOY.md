...
> **غيّر كلمة المرور فورًا** (أو اضبط `SEED_ADMIN_USERNAME` / `SEED_ADMIN_PASSWORD`
> كمتغيّرات في خدمة الـ API قبل النشر). المدير هو من يرى قسم **التقارير**.

> **ترقية قاعدة بيانات قائمة:** هجرة `20260916120000_add_username_login` تشتقّ اسم
> مستخدم لكل حساب موجود من الجزء الذي يسبق `@` في بريده
> (`walid.kelzia@gmail.com` ← `walid.kelzia`)، وتفضّ التكرار بلاحقة من المعرّف.
> أي أنّ المستخدمين الحاليين يدخلون باسم المستخدم المشتقّ، لا ببريدهم.
