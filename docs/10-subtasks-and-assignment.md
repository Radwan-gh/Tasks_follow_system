...
- قسم "المسؤولون عن المهمة" — قائمة اختيار متعدّد فوق أعضاء اللوحة، عبر المكوّن
  المشترك `MemberChecklist` (`components/MemberPicker.tsx`): رقائق بأسماء المختارين
  فوق القائمة (تُلغى الاختيار بضغطة)، وحقل بحث بالاسم أو البريد يظهر عندما يتجاوز عدد
  الأعضاء **6**. نفس المكوّن يخدم إسناد المهام الفرعية **وقائمة تقييد الوصول**، فلا
  يوجد أكثر من سلوك واحد لاختيار الأشخاص في الويب.
...
يُستخدم أيضًا لتقييد الوصول، وفيه بحث ورقائق للمختارين بنفس قواعد الويب —
انظر [`12-mobile-app.md`](./12-mobile-app.md))، وقسم مهام فرعية (`features/cards/subtasks-section.tsx`)
